const lovelyProjectStrings = {
    en: {
        ...
        lovelyP2: 'All materials and their respective values necessary for cost and measurement calculations are being stored locally in categorized JSON files. Lovely Manager reads the files and displays the materials in dropdown menus in the frontend.',
    ...
    de: {
        ...
        lovelyP2: `Alle Materialien und die für Berechnungen notwendigen Werte werden lokal in JSON-Dateien gespeichert. Die Dateien werden vom Lovely Manager ausgelesen und die Materialien werden im Frontend via Ausklappmenüs angezeigt.`,
