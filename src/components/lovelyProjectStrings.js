const lovelyProjectStrings = {
    en: {
        ...
        lovelyP1: 'Lovely Manager is a cross-platform desktop application for Berlin frame manufacturing collective Lovely Projects. The app automates cost and frame/crate measurement calculations and outputs documents for clients and working instructions for workers. Lovely Manager was built in Electron using Node.js and the React framework.',
    ...
    de: {
        ...
        lovelyP1: 'Lovely Manager ist eine plattformübergreifende Desktop-Anwendung für die Berliner Rahmenmanufaktur Lovely Projects. Die App automatisiert die Kosten-, sowie die Rahmen-/Kistenmaßberechnungen und gibt Kundendokumente und Laufzettel für die Arbeiter aus. Lovely Manager läuft in Electron und wurde mit React und Node.js gebaut.',
