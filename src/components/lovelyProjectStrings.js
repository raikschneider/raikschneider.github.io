const lovelyProjectStrings = {
    en: {
        ...
        lovelyH2: 'A multitude of materials',
        ...
        lovelyH5: 'A frame for every artwork',
        ...
        lovelyP6: `When all selections have been made, documents (work sheets, invoices etc.) are created and the order including all its files are being stored locally and can be re-opened at a later time. Orders are categorized by customer and date and are thus easy to find.`,
        lovelyH7: 'Summary',
    ...
    de: {
        ...
        lovelyH2: 'Eine Vielzahl an Materialien',
        ...
        lovelyH3: 'Und wenn sich die Daten ändern?',
        lovelyP3: 'In der App findet sich eine Benutzeroberfläche, die es dem Nutzer ermöglicht, Materialien und die dazugehörigen Werte zu modifizieren, falls sich Preise und Dimensionen in der Zukunft ändern sollten. Mit der Hilfe von Node.js kann der Benutzer ganz leicht Materialien und die respektiven Werte bearbeiten, hinzufügen oder löschen.',
        lovelyH4: 'Daten gehen auf Reise',
