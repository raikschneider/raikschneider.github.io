...
export default function LovelyProjectCard({ language, setCurrentPage, toggleDropshadow }) {
    return (
        <div className="project-card-image-container" onMouseEnter={() => toggleDropshadow(document.querySelector('#LMimg'))} onMouseLeave={() => toggleDropshadow(document.querySelector('#LMimg'))}>
