...
export default function ALSProjectCard({ language, setCurrentPage, toggleDropshadow }) {
  return (
    <div className="project-card-image-container" onMouseEnter={() => toggleDropshadow(document.querySelector('#ALSimg'))} onMouseLeave={() => toggleDropshadow(document.querySelector('#ALSimg'))}>
